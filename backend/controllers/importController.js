...
const getEmployeeTemplate = async (req, res) => {
    try {
        ...
        const templateData = [
            {
                ...
                'UAN': '100123456789',
                'PF Number': 'MH/BAN/0012345/000/0001234',
                'ESI Number': '31000000000000001',
                'Bank Name': 'HDFC Bank',
        ...
        console.error('Error in getEmployeeTemplate:', err);
        res.status(500).json({ success: false, message: 'Error generating employee import template', error: err.message });
    }
};
