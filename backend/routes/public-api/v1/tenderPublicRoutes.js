...
// GET /api/v1/tenders/dashboard
router.get('/dashboard', requireApiScope('tenders.read'), async (req, res) => {
...
// GET /api/v1/tenders
router.get('/', requireApiScope('tenders.read'), async (req, res) => {
    const tenders = [
...
// POST /api/v1/tenders
router.post('/', requireApiScope('tenders.write'), async (req, res) => {
    return sendSuccess(res, {
