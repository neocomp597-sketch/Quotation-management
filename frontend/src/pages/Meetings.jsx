...
const Meetings = () => {
    ...
    // Navigate to Create/Edit Page instead of modal popup
    const handleOpenDrawer = (mode, meetingId = null, prefillDate = null) => {
        if (mode === 'create') {
            navigate(`/meetings/new${prefillDate ? `?date=${prefillDate}` : ''}`);
        } else if (meetingId) {
