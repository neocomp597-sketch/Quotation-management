        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    ...
                    { label: 'Final/PO Received', value: wonCount, icon: MdCheckCircle, color: 'text-teal-600', bg: 'bg-teal-50' },
                                    ...
                                    <tr key={e._id} className="group hover:bg-primary-50/30 transition-colors duration-300">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <button
                                                    onClick={() => navigate(`/enquiries/view/${e._id}`)}
                                                    className="font-black text-teal-600 hover:text-teal-800 hover:underline tracking-tight text-sm text-left"
                                                    title="View full enquiry details page"
                                                >
                                                    {e.enquiryNo}
                                                </button>
                                            </div>
