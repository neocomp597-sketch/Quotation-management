...
const Simulations = () => {
  const [basePrice, setBasePrice] = useState(24003);
  ...
  const results = useMemo(() => {
    ...
    const winProb = Math.min(
      95,
      20 + discount * 1.8 - discount * discount * 0.015,
    );
  ...
  const pieData = [
    ...
    {
      name: "Profit",
      value: Math.max(0, results.netPrice - cost),
      color: "#10b981",
    },
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary-500/70">
                Intelligence Module
              </span>
            </div>
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <MdAttachMoney
                ...
                size={140}
              />
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] opacity-80 mb-4">
                Total Revenue
              </h3>
              <div className="text-4xl font-black font-outfit tracking-tighter">
                ₹<AnimatedNumber value={Math.round(results.totalRevenue)} />
              </div>
              <div className="mt-4 text-[10px] font-bold bg-white/15 px-3 py-1.5 rounded-full w-fit backdrop-blur-md border border-white/10">
                Incl. ₹{Math.round(results.taxAmount).toLocaleString()} tax
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-4xl font-black text-emerald-600 font-outfit tracking-tighter">
              ...
              <div className="absolute bottom-0 left-0 w-full h-2 bg-slate-50 overflow-hidden">
                <motion.div
                  ...
                  initial={{ width: 0 }}
                  animate={{
                    width: `${Math.min(100, Math.max(0, results.margin))}%`,
                  }}
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-4xl font-black text-slate-900 font-outfit tracking-tighter">
                {Math.round(results.winProb)}%
              </div>
              <div className="mt-4 flex items-center gap-2">
                <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                  <motion.div
                    className="h-full bg-primary-500 shadow-[0_0_15px_#14b8a6]"
                    initial={{ width: 0 }}
                    animate={{ width: `${results.winProb}%` }}
                  />
                </div>
              </div>
            </motion.div>
                ...
                <div className="shrink-0 group relative">
                  ...
                  <div className="w-48 h-48 rounded-full border-[14px] border-white/5 flex items-center justify-center relative bg-slate-900/50 backdrop-blur-xl">
                    <div className="text-center">
                      ...
                      <p className="text-6xl font-black text-white font-outfit">
                        <AnimatedNumber
                          value={Math.round(
                            (results.margin * 2 + results.winProb) / 3,
                          )}
                        />
                      </p>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-premium">
              <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-10">
                Profit Ecosystem
              </h3>
              <div className="h-64">
