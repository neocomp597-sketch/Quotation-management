export const MENU_PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'master_bom', label: 'BOM Master', description: 'View BOMs (needed by approvers too)', defaultRoute: '/bom-master' },
            { key: 'bom_create', label: 'BOM - Create / Edit', description: 'Create, edit, submit and revise BOMs', defaultRoute: '/bom-master' },
            { key: 'eng_bom_check', label: 'BOM - Checked By', description: 'First approval stage: check a submitted BOM', defaultRoute: '/bom-master' },
            { key: 'eng_bom_approve_engineering', label: 'BOM - Engineering Approval', description: 'Engineering approval stage for BOMs', defaultRoute: '/bom-master' },
            { key: 'eng_bom_approve_finance', label: 'BOM - Finance / Costing Review', description: 'Finance and costing review stage for BOMs', defaultRoute: '/bom-master' },
            { key: 'eng_bom_approve_management', label: 'BOM - Management Approval', description: 'Final approval, release and obsolete BOMs', defaultRoute: '/bom-master' },
    ...
    },
    {
        ...
        children: [
            ...
            { key: 'csm_attendance', label: 'Field Attendance', description: 'Field engineer attendance register and GPS check-in/out', defaultRoute: '/csm/field-attendance' },
