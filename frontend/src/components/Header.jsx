...
const searchablePages = [
    ...
    { label: 'Product Master', path: '/products', permissionKey: 'master_products', keywords: ['items', 'catalog', 'products'] },
    ...
    { label: 'Product MGR Master', path: '/mgrs', permissionKey: 'master_mgrs', keywords: ['mgr', 'mgr master'] },
    { label: 'Product BOM Master', path: '/bom-master', permissionKey: 'master_bom', keywords: ['bom', 'bom master', 'bill of materials'] },
    ...
    { label: 'Service Reports', path: '/csm/reports', permissionKey: 'csm_reports', keywords: ['csm reports'] },
    { label: 'RCA Report', path: '/csm/rca', permissionKey: 'csm_rca', keywords: ['rca', 'root cause analysis', 'capa'] },
