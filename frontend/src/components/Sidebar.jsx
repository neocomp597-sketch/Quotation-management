    ...
    const menuStructure = useMemo(() => [
        ...
        },
        {
            ...
            children: [
                ...
                { key: 'master_bom', name: 'Product BOM Master', icon: <MdAccountTree size={18} />, path: '/bom-master' },
                { key: 'master_products', name: 'Product Master', icon: <MdInventory size={18} />, path: '/products' },
                { key: 'master_mgrs', name: 'Product MGR Master', icon: <MdCategory size={18} />, path: '/mgrs' },
        ...
        },
        {
            ...
            children: [
                ...
                { key: 'csm_attendance', name: 'Field Attendance', icon: <MdHowToReg size={18} />, path: '/csm/field-attendance' },
